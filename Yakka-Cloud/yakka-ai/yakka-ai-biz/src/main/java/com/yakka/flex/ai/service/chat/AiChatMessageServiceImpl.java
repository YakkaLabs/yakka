package com.yakka.flex.ai.service.chat;
...
import com.yakka.flex.ai.controller.chat.vo.conversation.AiDelReqVO;
import com.yakka.flex.ai.controller.chat.vo.conversation.AiChatConversationUpdateMyReqVO;
import com.yakka.flex.ai.controller.chat.vo.message.AiChatMessagePageReqVO;
import com.yakka.flex.ai.controller.chat.vo.message.AiChatMessageRespVO;
import com.yakka.flex.ai.controller.chat.vo.message.AiChatMessageSendReqVO;
import com.yakka.flex.ai.controller.chat.vo.message.AiChatMessageSendRespVO;

import com.yakka.flex.ai.core.model.strategy.chat.ChatCallStrategy;
import com.yakka.flex.ai.core.model.strategy.chat.ChatStrategyFactory;
import com.yakka.flex.ai.core.model.strategy.chat.ChatStreamingStrategy;
import com.yakka.flex.ai.core.model.strategy.chat.ReasoningChunk;
import com.yakka.flex.ai.dal.chat.AiChatConversationDO;
import com.yakka.flex.ai.dal.chat.AiChatMessageDO;
import com.yakka.flex.ai.dal.knowledge.AiKnowledgeDocumentDO;
import com.yakka.flex.ai.dal.model.AiChatRoleDO;
import com.yakka.flex.ai.dal.model.AiModelDO;
import com.yakka.flex.ai.dal.model.AiToolDO;
import com.yakka.flex.ai.enums.AiChatMessageContentTypeEnum;
import com.yakka.flex.ai.enums.AiPlatformEnum;
import com.yakka.flex.ai.enums.ErrorCodeConstants;
import com.yakka.flex.ai.mapper.chat.AiChatMessageMapper;
import com.yakka.flex.ai.service.knowledge.AiKnowledgeDocumentService;
import com.yakka.flex.ai.service.knowledge.AiKnowledgeSegmentService;
import com.yakka.flex.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import com.yakka.flex.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import com.yakka.flex.ai.service.model.AiChatRoleService;
import com.yakka.flex.ai.service.model.AiModelService;
import com.yakka.flex.ai.service.model.AiModelUsageService;
import com.yakka.flex.ai.service.model.AiApiKeyService;
import com.yakka.flex.ai.dal.model.AiApiKeyDO;

import com.yakka.flex.ai.core.model.openrouter.OpenRouterApiConstants;
import com.yakka.flex.ai.core.model.silicon.SiliconFlowApiConstants;
import com.yakka.flex.ai.service.model.AiToolService;
import com.yakka.flex.ai.utils.AiUtils;
...
import static com.yakka.basic.utils.collection.CollectionUtils.convertSet;
import static com.yakka.flex.ai.common.pojo.CommonResult.error;
import static com.yakka.basic.base.R.success;
import static com.yakka.flex.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static com.yakka.flex.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
import static com.yakka.flex.ai.enums.ErrorCodeConstants.CHAT_PROMPT_TOO_LONG;
import static com.yakka.flex.ai.utils.ServiceExceptionUtil.exception;
