package com.yakka.flex.ai.config;
...
import com.yakka.basic.jackson.YakkaJacksonModule;
import com.yakka.basic.utils.SpringUtils;
import com.yakka.flex.ai.core.AiModelFactory;
import com.yakka.flex.ai.core.AiModelFactoryImpl;
import com.yakka.flex.ai.core.model.BaiChuanChatModel;
import com.yakka.flex.ai.core.model.DeepSeekChatModel;
import com.yakka.flex.ai.core.model.DouBaoChatModel;
import com.yakka.flex.ai.core.model.HunYuanChatModel;
import com.yakka.flex.ai.core.model.MidjourneyApi;
import com.yakka.flex.ai.core.model.SunoApi;
import com.yakka.flex.ai.core.model.XingHuoChatModel;
import com.yakka.flex.ai.core.model.google.GeminiChatModel;
import org.springframework.ai.openai.OpenAiChatModel;
import org.springframework.ai.openai.OpenAiChatOptions;
import org.springframework.ai.openai.api.OpenAiApi;
import com.yakka.flex.ai.core.model.openrouter.OpenRouterApiConstants;
import com.yakka.flex.ai.core.model.openrouter.OpenRouterChatModel;
import com.yakka.flex.ai.core.model.silicon.SiliconFlowApiConstants;
import com.yakka.flex.ai.core.model.silicon.SiliconFlowChatModel;
...
public class AiAutoConfiguration {
    ...
    @Bean
    @ConditionalOnProperty(value = "yakka.ai.deepseek.enable", havingValue = "true")
    ...
    @Bean
    @ConditionalOnProperty(value = "yakka.ai.doubao.enable", havingValue = "true")
    ...
    @Bean
    @ConditionalOnProperty(value = "yakka.ai.siliconflow.enable", havingValue = "true")
    ...
    @Bean
    @ConditionalOnProperty(value = "yakka.ai.hunyuan.enable", havingValue = "true")
    ...
    @Bean
    @ConditionalOnProperty(value = "yakka.ai.xinghuo.enable", havingValue = "true")
    ...
    @Bean
    @ConditionalOnProperty(value = "yakka.ai.baichuan.enable", havingValue = "true")
    ...
    @Bean
    @ConditionalOnProperty(value = "yakka.ai.openrouter.enable", havingValue = "true")
    ...
    @Bean
    @ConditionalOnProperty(value = "yakka.ai.midjourney.enable", havingValue = "true")
    ...
    @Bean
    @ConditionalOnProperty(value = "yakka.ai.suno.enable", havingValue = "true")
    public SunoApi sunoApi(HulaAiProperties hulaAiProperties) {
        return new SunoApi(hulaAiProperties.getSuno().getBaseUrl());
    }

    @Bean
    @ConditionalOnProperty(value = "yakka.ai.gemini.enable", havingValue = "true")
	...
	public ObjectMapper jacksonObjectMapper(Jackson2ObjectMapperBuilder builder) {
		...
		// 注册自定义模块
		objectMapper.registerModule(new YakkaJacksonModule()).findAndRegisterModules();
