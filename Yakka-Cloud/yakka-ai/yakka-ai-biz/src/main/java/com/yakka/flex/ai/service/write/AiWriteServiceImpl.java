package com.yakka.flex.ai.service.write;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import com.yakka.flex.ai.common.pojo.PageResult;
import com.yakka.flex.ai.controller.write.vo.AiWriteGenerateReqVO;
...
import com.yakka.flex.ai.enums.AiChatRoleEnum;
import com.yakka.flex.ai.enums.AiModelTypeEnum;
import com.yakka.flex.ai.enums.AiPlatformEnum;
import com.yakka.flex.ai.enums.AiWriteTypeEnum;
import com.yakka.flex.ai.enums.DictTypeConstants;
import com.yakka.flex.ai.enums.ErrorCodeConstants;
import com.yakka.flex.ai.mapper.write.AiWriteMapper;
...
import com.yakka.flex.ai.utils.DictFrameworkUtils;
...
public class AiWriteServiceImpl implements AiWriteService {
    ...
    @Override
    public Flux<R<String>> generateWriteContent(AiWriteGenerateReqVO generateReqVO, Long userId) {
        ...
        return streamResponse.map(chunk -> {
            ...
            // 忽略租户，因为 Flux 异步无法透传租户
        }).onErrorResume(error -> Flux.just(R.fail(ErrorCodeConstants.WRITE_STREAM_ERROR.getMsg())));
    }
