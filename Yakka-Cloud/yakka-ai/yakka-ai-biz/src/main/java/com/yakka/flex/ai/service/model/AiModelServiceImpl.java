package com.yakka.flex.ai.service.model;
...
import com.yakka.flex.ai.controller.model.vo.model.AiModelPageReqVO;
import com.yakka.flex.ai.controller.model.vo.model.AiModelSaveMyReqVO;
import com.yakka.flex.ai.controller.model.vo.model.AiModelSaveReqVO;
...
import com.yakka.flex.ai.mapper.model.AiChatMapper;
...
public class AiModelServiceImpl implements AiModelService {
	...
	@Override
	public com.yakka.flex.ai.core.model.video.VideoModel getVideoModel(Long id) {
		AiModelDO model = validateModel(id);
		AiApiKeyDO apiKey = apiKeyService.validateApiKey(model.getKeyId());
		AiPlatformEnum platform = AiPlatformEnum.validatePlatform(apiKey.getPlatform());
	...
	@Override
	public com.yakka.flex.ai.core.model.audio.AudioModel getAudioModel(Long id) {
		AiModelDO model = validateModel(id);
		AiApiKeyDO apiKey = apiKeyService.validateApiKey(model.getKeyId());
		AiPlatformEnum platform = AiPlatformEnum.validatePlatform(apiKey.getPlatform());
