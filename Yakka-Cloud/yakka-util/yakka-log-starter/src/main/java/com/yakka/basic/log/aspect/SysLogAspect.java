package com.yakka.basic.log.aspect;
...
import com.yakka.basic.log.event.SysLogEvent;
import com.yakka.basic.log.util.LogUtil;
import com.yakka.basic.log.util.ThreadLocalParam;
...
public class SysLogAspect {
     ...
     *
     * execution(public * com.yakka.basic.base.controller.*.*(..)) 解释：
     * 第一个* 任意返回类型
     * 第二个* com.yakka.basic.base.controller包下的所有类
     * 第三个* 类下的所有方法
     * ()中间的.. 任意参数
     *
     * \@annotation(com.yakka.basic.annotation.log.WebLog) 解释：
     * 标记了@WebLog 注解的方法
     */
    @Pointcut("execution(public * com.yakka.basic.base.controller.*.*(..)) || @annotation(com.yakka.basic.annotation.log.WebLog)")
