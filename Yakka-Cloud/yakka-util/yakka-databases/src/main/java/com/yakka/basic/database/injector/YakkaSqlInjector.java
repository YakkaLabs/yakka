package com.yakka.basic.database.injector;
...
import com.yakka.basic.database.injector.method.UpdateAllById;
 ...
 */
public class YakkaSqlInjector extends DefaultSqlInjector {
    @Override
