package com.yakka.basic.jackson;
...
import com.yakka.basic.converter.YakkaLocalDateTimeDeserializer;
...
import static com.yakka.basic.utils.DateUtils.DEFAULT_TIME_FORMAT;
...
public class YakkaJacksonModule extends SimpleModule {
    ...
    public YakkaJacksonModule() {
        super();
        this.addDeserializer(LocalDateTime.class, YakkaLocalDateTimeDeserializer.INSTANCE);
