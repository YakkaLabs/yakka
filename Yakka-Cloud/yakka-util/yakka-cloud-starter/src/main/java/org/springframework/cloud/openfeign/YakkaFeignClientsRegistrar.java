...
import com.yakka.basic.cloud.config.OpenFeignAutoConfiguration;
...
@Getter
@Slf4j
public class YakkaFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
