...
import com.yakka.flex.im.api.hystrix.DefUserApiFallback;
 ...
 * @date 2019/07/02
 */
@FeignClient(name = "${" + Constants.PROJECT_PREFIX + ".feign.tenant-server:yakka-base-server}", fallback = DefUserApiFallback.class)
