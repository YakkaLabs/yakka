package com.yakka.flex.generator.converts;

import com.yakka.flex.generator.config.DateType;
import com.yakka.flex.generator.rules.ColumnType;
import com.yakka.flex.generator.rules.DbColumnType;

import static com.yakka.flex.generator.converts.TypeConverts.contains;
import static com.yakka.flex.generator.converts.TypeConverts.containsAny;
import static com.yakka.flex.generator.rules.DbColumnType.BIG_DECIMAL;
import static com.yakka.flex.generator.rules.DbColumnType.BLOB;
import static com.yakka.flex.generator.rules.DbColumnType.BOOLEAN;
import static com.yakka.flex.generator.rules.DbColumnType.BYTE_ARRAY;
import static com.yakka.flex.generator.rules.DbColumnType.CLOB;
import static com.yakka.flex.generator.rules.DbColumnType.DOUBLE;
import static com.yakka.flex.generator.rules.DbColumnType.FLOAT;
import static com.yakka.flex.generator.rules.DbColumnType.INTEGER;
import static com.yakka.flex.generator.rules.DbColumnType.LONG;
