...
import com.yakka.flex.generator.rules.echo.EchoDict;
import com.yakka.flex.generator.rules.echo.EchoType;
import com.yakka.flex.generator.rules.enumeration.EnumType;
import com.yakka.flex.generator.rules.enumeration.EnumTypeKeyValue;
...
public class CommentUtils {
     ...
     * <p>
     * api、ref、beanClass、dictType 中使用的类需要提前在 yakka.generator.constantsPackage 中配置
     * <p>
     * 如：
     * 匹配： @Echo(api="")
