package com.yakka.flex.test.entity;
...
import com.yakka.basic.base.entity.Entity;
import com.yakka.flex.test.enumeration.DefGenTestSimpleType2Enum;
import com.yakka.flex.test.enumeration.ProductType;
...
import static com.yakka.flex.model.constant.Condition.LIKE;
...
public class DefGenTestSimple extends Entity<Long> {
     ...
     * 字符字典;
     *
     * @Echo(api = "com.yakka.flex.oauth.api.DictionaryApi", dictType="GLOBAL_SEX")
     */
