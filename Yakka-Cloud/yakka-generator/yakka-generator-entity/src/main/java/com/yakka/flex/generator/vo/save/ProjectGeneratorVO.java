package com.yakka.flex.generator.vo.save;
...
public class ProjectGeneratorVO implements Serializable {
    ...
    /**
     * yakka项目 生成代码位于 src/main/java 下的基础包
     * 如： com.yakka.flex.base.dao.common 包中的 com.yakka.flex
     * 如： com.yakka.flex.file.dao.xxx 包中的 com.yakka.flex
     */
