package com.yakka.flex.service;

import com.yakka.flex.dao.ModelDao;
import com.yakka.flex.model.Model;
import com.yakka.flex.res.ModelVO;
...
public class ModelService {
	 ...
	 * 查询所有启用的模型列表
	 */
	@Cacheable(cacheNames = "yakka:model", key = "'list'")
