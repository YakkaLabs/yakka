...
import com.yakka.basic.cache.redis.BaseRedis;
...
import com.yakka.flex.common.cache.FriendCacheKeyBuilder;
...
import com.yakka.flex.im.domain.enums.ApplyReadStatusEnum;
import com.yakka.flex.im.domain.enums.NoticeStatusEnum;
...
import com.yakka.flex.im.domain.vo.request.friend.FriendPermissionReq;
import com.yakka.flex.im.domain.vo.request.friend.FriendRemarkReq;
...
import com.yakka.flex.im.domain.entity.UserFriend;
import com.yakka.flex.im.domain.vo.req.friend.FriendCheckReq;
import com.yakka.flex.im.domain.vo.req.friend.FriendReq;
import com.yakka.flex.im.domain.vo.resp.friend.FriendCheckResp;
import com.yakka.flex.im.domain.vo.resp.friend.FriendResp;
...
//		cachePlusOps.set(new CacheKey("yakka:user:total_count"), dbCount);
		baseRedis.set("yakka:user:total_count", dbCount);
	}
	...
	public void createSystemFriend(Long uid){
		...
		Long total = cachePlusOps.inc("yakka:user:total_count", 0, TimeUnit.DAYS); // 查询系统总注册人员
