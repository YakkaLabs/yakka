...
import com.yakka.flex.im.enums.UserTypeEnum;
import com.yakka.flex.im.domain.vo.response.ChatMemberListResp;
import com.yakka.flex.model.entity.base.IpDetail;
...
public class UserSummaryCache extends AbstractRedisStringCache<Long, SummeryInfoDTO> {
	 ...
	 * @return
	 */
	@Cacheable(cacheNames = "yakka:user", key = "'findFriend:'+#key")
	 ...
	 * @return
	 */
	@CacheEvict(cacheNames = "yakka:user", key = "'findFriend:'+#key")
	public List<Long> evictFriend(String key) {
		return null;
	}

	@TenantIgnore
//	@Cacheable(cacheNames = "yakka:user", key = "'blackList'")
...
//	@CacheEvict(cacheNames = "yakka:user", key = "'blackList'")
