...
import com.yakka.flex.im.core.user.mapper.UserFriendMapper;
...
public class UserFriendDao extends ServiceImpl<UserFriendMapper, UserFriend> {
	 ...
	 * @return
	 */
	@Cacheable(cacheNames = "yakka:friend", key = "'list:'+#uid")
	 ...
	 * @return
	 */
	@Cacheable(cacheNames = "yakka:userFriend", key = "'room:'+#roomId+':uid:'+#uid", unless = "#result == null")
	 ...
	 * @param uid    用户ID
	 */
	@CacheEvict(cacheNames = "yakka:userFriend", key = "'room:'+#roomId+':uid:'+#uid")
