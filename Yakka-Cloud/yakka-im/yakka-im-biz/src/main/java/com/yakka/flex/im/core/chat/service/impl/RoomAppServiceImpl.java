package com.yakka.flex.im.core.chat.service.impl;
...
import com.yakka.basic.exception.code.ResponseEnum;
...
import com.yakka.flex.common.constant.DefValConstants;
import com.yakka.flex.im.core.chat.dao.RoomFriendDao;
import com.yakka.flex.im.core.chat.dao.RoomGroupDao;
import com.yakka.flex.im.core.user.dao.NoticeDao;
import com.yakka.flex.im.core.user.dao.UserApplyDao;
import com.yakka.flex.im.core.user.dao.UserBackpackDao;
import com.yakka.flex.im.core.user.dao.UserFriendDao;
import com.yakka.flex.im.core.user.dao.UserPrivacyDao;
...
import com.yakka.flex.im.domain.dto.SummeryInfoDTO;
import com.yakka.flex.im.domain.entity.*;
import com.yakka.flex.im.domain.enums.*;
import com.yakka.flex.im.domain.vo.req.room.DisbandGroupReq;
import com.yakka.flex.im.domain.vo.req.room.GroupMemberPageReq;
import com.yakka.flex.im.domain.vo.req.room.GroupPageReq;
import com.yakka.flex.im.domain.vo.req.room.UpdateMemberNicknameReq;
import com.yakka.flex.im.domain.vo.request.ChatMessageReq;
import com.yakka.flex.im.domain.vo.request.admin.AdminSetReq;
import com.yakka.flex.im.domain.vo.request.member.MemberExitReq;
import com.yakka.flex.im.domain.entity.msg.TextMsgReq;
import com.yakka.flex.im.domain.vo.res.PageBaseResp;
import com.yakka.flex.im.domain.vo.resp.room.GroupMemberSimpleResp;
import com.yakka.flex.im.domain.vo.response.GroupResp;
import com.yakka.flex.model.entity.ws.AdminChangeDTO;
import com.yakka.flex.model.enums.ChatActiveStatusEnum;
import com.yakka.flex.im.domain.vo.request.contact.ContactAddReq;
...
import com.yakka.flex.model.redis.annotation.RedissonLock;
...
import com.yakka.flex.im.core.chat.dao.ContactDao;
import com.yakka.flex.im.core.chat.dao.GroupMemberDao;
import com.yakka.flex.im.core.chat.dao.MessageDao;
import com.yakka.flex.im.domain.dto.RoomBaseInfo;
import com.yakka.flex.im.domain.vo.request.ChatMessageMemberReq;
import com.yakka.flex.im.domain.vo.request.ContactFriendReq;
import com.yakka.flex.im.domain.vo.request.GroupAddReq;
import com.yakka.flex.im.domain.vo.request.RoomInfoReq;
import com.yakka.flex.im.domain.vo.request.RoomMyInfoReq;
import com.yakka.flex.im.domain.vo.request.contact.ContactHideReq;
import com.yakka.flex.im.domain.vo.request.contact.ContactNotificationReq;
import com.yakka.flex.im.domain.vo.request.contact.ContactShieldReq;
import com.yakka.flex.im.domain.vo.request.contact.ContactTopReq;
import com.yakka.flex.im.domain.vo.request.member.MemberAddReq;
import com.yakka.flex.im.domain.vo.request.member.MemberDelReq;
import com.yakka.flex.im.domain.vo.request.member.MemberReq;
import com.yakka.flex.im.domain.vo.request.room.AnnouncementsParam;
import com.yakka.flex.im.domain.vo.request.room.ReadAnnouncementsParam;
import com.yakka.flex.im.domain.vo.request.room.RoomGroupReq;
import com.yakka.flex.im.domain.vo.response.AnnouncementsResp;
import com.yakka.flex.im.domain.vo.response.ChatMemberListResp;
import com.yakka.flex.im.domain.vo.response.ChatRoomResp;
import com.yakka.flex.im.domain.vo.response.MemberResp;
import com.yakka.flex.im.domain.vo.response.ReadAnnouncementsResp;
import com.yakka.flex.im.core.chat.service.ChatService;
import com.yakka.flex.im.core.chat.service.RoomAppService;
import com.yakka.flex.im.core.chat.service.RoomService;
import com.yakka.flex.im.core.chat.service.adapter.ChatAdapter;
import com.yakka.flex.im.core.chat.service.adapter.MemberAdapter;
import com.yakka.flex.im.core.chat.service.adapter.MessageAdapter;
...
import com.yakka.flex.im.core.chat.service.cache.HotRoomCache;
import com.yakka.flex.im.core.chat.service.cache.RoomAnnouncementsCache;
import com.yakka.flex.im.core.chat.service.cache.RoomCache;
import com.yakka.flex.im.core.chat.service.cache.RoomFriendCache;
import com.yakka.flex.im.core.chat.service.cache.RoomGroupCache;
import com.yakka.flex.im.core.chat.service.strategy.msg.AbstractMsgHandler;
import com.yakka.flex.im.core.chat.service.strategy.msg.MsgHandlerFactory;
import com.yakka.flex.im.core.user.dao.UserDao;
import com.yakka.flex.model.entity.WsBaseResp;
import com.yakka.flex.im.domain.vo.req.MergeMessageReq;
import com.yakka.flex.model.entity.ws.ChatMemberResp;
import com.yakka.flex.model.entity.ws.WSMemberChange;
import com.yakka.flex.im.core.user.service.FriendService;
...
import static com.yakka.flex.im.core.chat.constant.GroupConst.MAX_MANAGE_COUNT;
import static com.yakka.flex.im.domain.enums.ApplyReadStatusEnum.UNREAD;
/**
 * 聊天室应用服务实现类
 * - 聊天室创建、管理和维护
 * - 群组成员管理（添加、删除、管理员设置）
