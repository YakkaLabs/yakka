...
import com.yakka.flex.model.entity.base.UserReq;
...
import com.yakka.flex.im.domain.vo.req.user.BlackAddReq;
import com.yakka.flex.im.domain.vo.req.user.BlackEditReq;
import com.yakka.flex.im.domain.vo.req.user.BlackPageReq;
import com.yakka.flex.im.domain.vo.req.user.BlackRemoveReq;
import com.yakka.flex.im.domain.vo.req.user.UserSearchReq;
import com.yakka.flex.im.domain.vo.req.user.ItemInfoReq;
import com.yakka.flex.im.domain.vo.req.user.ModifyAvatarReq;
import com.yakka.flex.im.domain.vo.req.user.ModifyNameReq;
import com.yakka.flex.im.domain.vo.req.user.WearingBadgeReq;
