...
import static com.yakka.flex.oauth.granter.MobileTokenGranter.GRANT_TYPE;
...
public class MobileTokenGranter extends AbstractTokenGranter implements TokenGranter {
	...
	public MobileTokenGranter(SystemProperties systemProperties, DefClientService defClientService, DefUserService defUserService, BaseEmployeeService baseEmployeeService, BaseOrgService baseOrgService, SaTokenConfig saTokenConfig, ImUserApi userApi, com.yakka.flex.oauth.biz.StpInterfaceBiz stpInterfaceBiz) {
