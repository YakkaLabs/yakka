...
import com.yakka.flex.oauth.AesUtil;
import com.yakka.flex.oauth.cache.QrCacheKeyBuilder;
import com.yakka.flex.oauth.emuns.QrLoginState;
import com.yakka.flex.oauth.vo.param.ConfirmReq;
import com.yakka.flex.oauth.vo.param.LoginParamVO;
import com.yakka.flex.oauth.vo.param.QueryStatusReq;
import com.yakka.flex.oauth.vo.param.ScanReq;
import com.yakka.flex.oauth.vo.result.LoginResultVO;
import com.yakka.flex.oauth.vo.result.QrCodeResp;
import com.yakka.flex.oauth.vo.result.QrCodeResult;
import com.yakka.flex.oauth.vo.result.QrCodeStatus;
import com.yakka.flex.oauth.vo.result.ScanResp;
...
public class QrCodeGranter extends AbstractTokenGranter {
	...
	public QrCodeGranter(SystemProperties systemProperties, DefClientService defClientService, DefUserService defUserService, BaseEmployeeService baseEmployeeService, BaseOrgService baseOrgService, SaTokenConfig saTokenConfig, ImUserApi imUserApi, com.yakka.flex.oauth.biz.StpInterfaceBiz stpInterfaceBiz) {
	 ...
	 * return 返回操作的过期时间
	 */
	@RedissonLock(prefixKey ="yakka:handleScan:", key = "#req.qrId")
...
//		}
	 ...
	 * return 返回操作的过期时间
	 */
	@RedissonLock(prefixKey ="yakka:confirmLogin:", key = "#req.qrId")
	...
	@RedissonLock(prefixKey ="yakka:checkStatus:", key = "#req.deviceHash")
