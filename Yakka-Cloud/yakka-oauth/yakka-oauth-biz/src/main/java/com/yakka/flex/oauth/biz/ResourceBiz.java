...
import com.yakka.flex.base.service.system.BaseRoleService;
import com.yakka.flex.base.vo.result.user.RouterMeta;
import com.yakka.flex.base.vo.result.user.VueRouter;
import com.yakka.flex.common.constant.BizConstant;
import com.yakka.flex.common.constant.RoleConstant;
...
import com.yakka.flex.oauth.enumeration.system.ClientTypeEnum;
import com.yakka.flex.oauth.enumeration.tenant.ResourceOpenWithEnum;
...
public class ResourceBiz {
    ...
    public List<VueRouter> findAllVisibleRouter(Long employeeId, String subGroup, ClientTypeEnum type) {
        ...
        for (DefApplication defApplication : applicationList) {
            ...
            if (ClientTypeEnum.YAKKA_WEB_PRO_SOYBEAN.eq(type)) {
                forEachTreeBySoybean(tree, 1, null);
            } else if (ClientTypeEnum.YAKKA_WEB_PRO_VBEN5.eq(type)) {
