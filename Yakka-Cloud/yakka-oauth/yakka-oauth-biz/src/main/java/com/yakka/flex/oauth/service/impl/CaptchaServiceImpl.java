package com.yakka.flex.oauth.service.impl;
...
import com.yakka.flex.model.enumeration.base.MsgTemplateCodeEnum;
import com.yakka.flex.msg.vo.update.ExtendMsgSendVO;
import com.yakka.flex.oauth.granter.CaptchaTokenGranter;
import com.yakka.flex.oauth.properties.CaptchaProperties;
...
import static com.yakka.basic.exception.code.ResponseEnum.CAPTCHA_ERROR;
...
//		long expireTime = 300;
//
//		com.yakka.flex.system.core.user.domain.dto.captcha.SpecCaptcha specCaptcha = new com.yakka.flex.system.core.user.domain.dto.captcha.SpecCaptcha(120, 45, 4);
//		// 设置类型，纯数字、纯字母、字母数字混合
//		specCaptcha.setCharType(com.yakka.flex.system.core.user.domain.dto.captcha.Captcha.TYPE_ONLY_NUMBER);
