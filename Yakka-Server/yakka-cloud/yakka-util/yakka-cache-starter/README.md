...
配置文件配置yakka.cache.type=redis后，注入 CachePlusOps 或者 RedisOps，程序直接使用RedisOps必须保证系统每次启动都依赖redis，
...
pom.xml
<dependency>
    <groupId>com.yakka.basic</groupId>
    <artifactId>yakka-cache-starter</artifactId>
</dependency>
