package com.yakka.basic.tenant.core.mq.rocketmq;
...
import static com.yakka.basic.context.ContextConstants.HEADER_TENANT_ID;
import static com.yakka.basic.context.ContextConstants.U_ID_HEADER;


/**
 * RocketMQ 消息队列的多租户 {@link ConsumeMessageHook} 实现类
 *
 * Consumer 消费消息时，将消息的 Header 的租户编号，添加到 {@link ContextUtil} 中，通过 {@link InvocableHandlerMethod} 实现
 */
public class TenantRocketMQConsumeMessageHook implements ConsumeMessageHook {
    ...
    public void consumeMessageBefore(ConsumeMessageContext context) {
		...
		if(uid != null){
			ContextUtil.setUid(Long.parseLong(uid));
		}
		if(tenantId != null){
