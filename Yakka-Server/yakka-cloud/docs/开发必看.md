...
1. 将 yakka-cloud/pom.xml 导入IDEA
2. 导入yakka-util项目
![img.png](preview/img.png)![img_1.png](preview/img_1.png)
3. 安装yakka-util到本地![img_2.png](preview/img_2.png)
4. 导入nacos环境，以我本地为例：127.0.0.1:8080![img5.png](preview/img5.png)![img_5.png](preview/img_5.png)
5. 修改redis.yml、mysql.yml、rocketmq.yml、yakka-im-server.yml的配置![img6.png](preview/img6.png)
6. 安装yakka-cloud到本地![img_3.png](preview/img_3.png)
7. 导入数据库 [yakka_dev.sql](install/sql/yakka_dev.sql)、[yakka_im_01.sql](install/sql/yakka_im_01.sql)
