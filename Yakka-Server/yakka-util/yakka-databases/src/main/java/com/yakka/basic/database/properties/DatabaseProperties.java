...
import static com.yakka.basic.database.properties.DatabaseProperties.PREFIX;
...
public class DatabaseProperties {
     ...
     * SCHEMA模式 租户库 前缀
     */
    private String tenantDatabasePrefix = "yakka_base";
    /**
     * DATASOURCE模式 租户库 前缀
     * <p>
     * 新增租户时，需要动态创建的数据库前缀。
     ...
     * <p>
     * 如：yakka项目原始的服务（基础服务、租户服务、认证服务、消息服务、文件服务、网关服务）
     * 总共链接了2个租户库： yakka_base_{TenantId}、yakka_extend_{TenantId}， 这里就要配置2个前缀
     */
