...
import static com.yakka.basic.utils.DateUtils.DEFAULT_DATE_FORMAT;
import static com.yakka.basic.utils.DateUtils.DEFAULT_DATE_FORMAT_EN;
import static com.yakka.basic.utils.DateUtils.DEFAULT_DATE_FORMAT_EN_MATCHES;
import static com.yakka.basic.utils.DateUtils.DEFAULT_DATE_FORMAT_MATCHES;
import static com.yakka.basic.utils.DateUtils.DEFAULT_DATE_TIME_FORMAT;
import static com.yakka.basic.utils.DateUtils.DEFAULT_DATE_TIME_FORMAT_EN;
import static com.yakka.basic.utils.DateUtils.DEFAULT_DATE_TIME_FORMAT_EN_MATCHES;
import static com.yakka.basic.utils.DateUtils.DEFAULT_DATE_TIME_FORMAT_MATCHES;
import static com.yakka.basic.utils.DateUtils.SLASH_DATE_FORMAT;
import static com.yakka.basic.utils.DateUtils.SLASH_DATE_FORMAT_MATCHES;
import static com.yakka.basic.utils.DateUtils.SLASH_DATE_TIME_FORMAT;
import static com.yakka.basic.utils.DateUtils.SLASH_DATE_TIME_FORMAT_MATCHES;
...
public class YakkaLocalDateTimeDeserializer extends JSR310DateTimeDeserializerBase<LocalDateTime> {
    public static final YakkaLocalDateTimeDeserializer INSTANCE = new YakkaLocalDateTimeDeserializer();
    ...
    private YakkaLocalDateTimeDeserializer() {
        this(DEFAULT_FORMATTER);
    }

    public YakkaLocalDateTimeDeserializer(DateTimeFormatter formatter) {
        super(LocalDateTime.class, formatter);
    }

    protected YakkaLocalDateTimeDeserializer(YakkaLocalDateTimeDeserializer base, Boolean leniency) {
        super(base, leniency);
    }
    ...
    @Override
    protected YakkaLocalDateTimeDeserializer withLeniency(Boolean leniency) {
        return new YakkaLocalDateTimeDeserializer(this, leniency);
    }
