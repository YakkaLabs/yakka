 ...
 */
@Slf4j
public class YakkaSentinelInvocationHandler implements InvocationHandler {
    ...
    YakkaSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
    ...
    public boolean equals(Object obj) {
        if (obj instanceof YakkaSentinelInvocationHandler other) {
