package com.yakka.basic.cloud.feign;
        ...
        super.invocationHandlerFactory(new InvocationHandlerFactory() {
            ...
            public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
                ...
                if (void.class != fallback) {
                    ...
                    return new YakkaSentinelInvocationHandler(target, dispatch, new FallbackFactory.Default<>(fallbackInstance));
                }
                if (void.class != fallbackFactory) {
                    ...
                    return new YakkaSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
                }
                return new YakkaSentinelInvocationHandler(target, dispatch);
            }
