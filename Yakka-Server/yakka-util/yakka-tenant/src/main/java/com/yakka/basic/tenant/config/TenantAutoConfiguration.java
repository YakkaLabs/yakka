package com.yakka.basic.tenant.config;

import cn.hutool.extra.spring.SpringUtil;
import com.baomidou.mybatisplus.extension.plugins.MybatisPlusInterceptor;
import com.baomidou.mybatisplus.extension.plugins.inner.TenantLineInnerInterceptor;
import com.yakka.basic.cache.properties.CustomCacheProperties;
import com.yakka.basic.enums.WebFilterOrderEnum;
import com.yakka.basic.tenant.TenantCommonApi;
import com.yakka.basic.tenant.core.aop.TenantIgnore;
import com.yakka.basic.tenant.core.aop.TenantIgnoreAspect;
import com.yakka.basic.tenant.core.db.TenantDatabaseInterceptor;
import com.yakka.basic.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.yakka.basic.tenant.core.redis.TenantRedisCacheManager;
import com.yakka.basic.tenant.core.service.TenantFrameworkService;
import com.yakka.basic.tenant.core.service.TenantFrameworkServiceImpl;
import com.yakka.basic.tenant.core.web.TenantContextWebFilter;
import com.yakka.basic.tenant.core.web.TenantVisitContextInterceptor;
import com.yakka.basic.utils.mybatis.MyBatisUtils;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "yakka.tenant", value = "enable", matchIfMissing = true) // 允许使用 yakka.tenant.enable=false 禁用多租户
